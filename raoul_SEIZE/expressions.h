...
const char * const  capsuleText [CAPS_TEXT_NUMBER] PROGMEM =
{
  caps_string_0,
  caps_string_1,
  caps_string_2,
...
const char random_string_6[] PROGMEM =  "Carpe diem, motherfvcker" ;
const char random_string_7[] PROGMEM =  "Tv coqve, filis" ;
const char random_string_8[] PROGMEM =  "Une blague ou ton Bacchus" ;
const char random_string_9[] PROGMEM =  "Bienvenue au Forvm!" ;
const char random_string_10[] PROGMEM =  "Assiez-toi donc sur une Seize" ;
const char random_string_11[] PROGMEM =  "Nunc est Bibendum" ;




const char * const randomText [RANDOM_TEXT_NUMBER] PROGMEM =
{
  random_string_0,
  random_string_1,
  random_string_2,
